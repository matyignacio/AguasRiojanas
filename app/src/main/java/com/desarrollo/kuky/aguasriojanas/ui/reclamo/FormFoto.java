...
import com.desarrollo.kuky.aguasriojanas.util.AutoFitTextureView;
...
import static com.desarrollo.kuky.aguasriojanas.ui.reclamo.NuevoReclamoActivity.formFoto;
...
import static com.desarrollo.kuky.aguasriojanas.util.Util.rotarBitMap;
...
public class FormFoto extends Fragment
    ...
    public interface OnItemSelectedListener {
        ...
        void onGuardarSelected(String resultado);
    }
    ...
    private Button bGuardar, bVolver;
     ...
     */
    private static final String TAG = "FormFoto";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_reclamo_form_foto, container, false);
    }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        bVolver = view.findViewById(R.id.bVolver);
        ////////////////////////////////////////////////////////////////////
        setPrimaryFontBold(this.getActivity(), bGuardar);
        setPrimaryFontBold(this.getActivity(), bVolver);
        ////////////////////////////////////////////////////////////////////
        ...
        bGuardar.setOnClickListener(v -> {
            try {
                ...
                listener.onGuardarSelected(EXITO);
            } catch (Exception e) {
                listener.onGuardarSelected(e.toString());
            }
        });
    }
    ...
    /**
     * Opens the camera specified by {@link FormFoto#mCameraId}.
     */
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface, mImageReader.getSurface()),
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigureFailed(
                            ...
                            mostrarMensaje(getActivity(), "Reopening");
                            createCameraPreviewSession();
                        }
                    }, null
            );
        ...
        public void run() {
            ...
            getActivity().runOnUiThread(() -> {
                try {
                    ...
                    NuevoReclamoActivity.reclamo.setFoto(imageToString(rotarBitMap(bmp, 90)));
                } catch (Exception e) {
