package com.desarrollo.kuky.aguasriojanas.ui.login;
...
public class EmailPasswordActivity extends BaseActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //findViewById(R.id.signOutButton).setOnClickListener(this)signOutButton;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            mostrarMensaje(EmailPasswordActivity.this,
                                    "Revise su direccion de correo para validar la cuenta.");
                            mAuth.signOut();
                            abrirActivity(EmailPasswordActivity.this, EmailPasswordActivity.class);
                        } else {
        ...
        user.sendEmailVerification()
                .addOnCompleteListener(this, new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            mostrarMensaje(EmailPasswordActivity.this, "Revise su correo " +
                                    user.getEmail() +
                                    ", se le envio un mensaje para validar la cuenta. ");
                        } else {
                            Log.e(TAG, "sendEmailVerification", task.getException());
                            mostrarMensaje(EmailPasswordActivity.this, "Failed to send verification email.");
                        }
                        // [END_EXCLUDE]
                    }
                });
